...
function aptGuideSection(base, repo) {
    ...
    return {
        ...
        note: "Use ArtiGate's high-side APT key (Signed-By), not the upstream vendor key. " +
...
function rpmGuideSection(base, repo) {
    return {
        ...
        note: "repo_gpgcheck=1 verifies repomd.xml against ArtiGate's high-side key; set " +
